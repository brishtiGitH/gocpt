...
const Regards = () => {
  return (
    <div className="min-h-screen w-full bg-black bg-opacity-5 backdrop-filter backdrop-blur-2xl regards-page-container text-center p-20 flex flex-col items-center justify-center gap-10">
