...
const Navbar = ({ scrollToFeaturePage, scrollToAbout, scrollToContact }) => {
  ...
  return (
    <div className="navbar z-50 top-0 left-0 right-0 fixed w-full flex gap-0 lg:gap-5 justify-evenly lg:justify-between items-center py-3 bg-opacity-5 backdrop-filter backdrop-blur-2xl">
