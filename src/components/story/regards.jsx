...
const Regards = ({ mode }) => {
  return (
    <div
      className={`min-h-screen w-full bg-black bg-opacity-5 backdrop-filter backdrop-blur-2xl regards-page-container text-center p-10 flex flex-col items-center justify-center gap-5 md:gap-10
      }`}
    >
